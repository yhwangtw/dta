...
export function MobileNavigation({
  ...
  return (
    <>
      ...
      <nav className={s.mobileNav} data-legacy={legacyMode || undefined} aria-label="Primary" aria-hidden={moreOpen || undefined} inert={moreOpen ? true : undefined}>
        <NavButton
        ...
        <NavButton
          ...
          label={legacyMode ? t("mobile.codingChat") : t("mobile.chat")}
          onClick={onShowChat}
        ...
        <section className={s.mobileMoreSheet} aria-label={t("mobile.moreActions")}>
          ...
          <div className={s.mobileMoreGroup}>
            ...
            <div className={s.mobileMoreGrid}>
              {legacyMode && <MoreAction label={t("agents.title")} active={panelOpen && panelView === "agents"} onClick={() => run(() => onSelectView("agents"))} icon={<svg {...iconProps}><rect x="4" y="4" width="16" height="16" rx="3" /><path d="M9 9h6M9 13h4" /><path d="M8 2v2M16 2v2" /></svg>} />}
              ...
              {legacyMode ? <>
                ...
                <MoreAction label={t("search.title")} active={panelOpen && panelView === "search"} onClick={() => run(() => onSelectView("search"))} icon={<svg {...iconProps}><circle cx="11" cy="11" r="7" /><line x1="20" y1="20" x2="16.5" y2="16.5" /></svg>} />
                ...
                {onOpenAnalytics && <MoreAction label={t("topbar.analytics")} onClick={() => run(onOpenAnalytics)} icon={<svg {...iconProps}><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg>} />}
          ...
          <div className={s.mobileMoreGroup}>
            ...
            <div className={s.mobileMoreGrid}>
              {legacyMode && <>
                {onOpenModels && <MoreAction label={t("sidebar.models")} onClick={() => run(onOpenModels)} icon={<svg {...iconProps}><rect x="4" y="4" width="16" height="16" rx="2" /><rect x="9" y="9" width="6" height="6" /></svg>} />}
                {onOpenSkills && <MoreAction label={t("sidebar.skills")} disabled={skillsDisabled} onClick={() => run(onOpenSkills)} icon={<svg {...iconProps}><path d="M12 2 2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" /></svg>} />}
                {onOpenExtensions && <MoreAction label={t("extensions.title")} onClick={() => run(onOpenExtensions)} icon={<svg {...iconProps}><path d="M20.5 11H19V7a2 2 0 0 0-2-2h-4V3.5a2.5 2.5 0 0 0-5 0V5H4a2 2 0 0 0-2 2v4h1.5a2.5 2.5 0 0 1 0 5H2v4a2 2 0 0 0 2 2h4v-1.5a2.5 2.5 0 0 1 5 0V22h4a2 2 0 0 0 2-2v-4h1.5a2.5 2.5 0 0 0 0-5z" /></svg>} />}
              </>}
              ...
              {legacyMode && onOpenDesignMode && <MoreAction label={t("topbar.designMode")} onClick={() => run(onOpenDesignMode)} icon={<svg {...iconProps}><path d="M12 3 4 7v10l8 4 8-4V7z" /><path d="m8 9 4 2 4-2M8 15l4 2 4-2M12 11v6" /></svg>} />}
            </div>
          </div>
        </section>
      )}
